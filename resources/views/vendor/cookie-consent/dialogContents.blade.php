        ...
        <div class="p-2 rounded-lg bg-blue-100">
            <div class="flex items-center justify-between flex-wrap">
                <div class="w-0 flex-1 items-center hidden md:inline">
                    <p class="ml-3 text-gray-900 cookie-consent__message">
                ...
                <div class="mt-2 flex-shrink-0 w-full sm:mt-0 sm:w-auto flex space-x-2">
                    ...
                    <button class="js-cookie-consent-decline cookie-consent__decline cursor-pointer flex items-center justify-center px-4 py-2 rounded-md text-sm font-medium text-white bg-gray-900 hover:bg-gray-600">
                        Decline
                    </button>
                </div>
            </div>
