        ...
        <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
            ...
            <div class="mt-16 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:grid-rows-2 sm:gap-x-6 lg:gap-8">
                ...
                <div v-if="categories.length > 1" class="group aspect-h-1 aspect-w-2 overflow-hidden rounded-lg sm:aspect-none sm:relative sm:h-full">
                    <img :src="'/storage/' + categories[1].image" :alt="categories[1].description" class="object-cover object-center group-hover:opacity-75 duration-300 ease-in-out group-hover:scale-110 sm:absolute sm:inset-0 sm:h-full sm:w-full" />
                ...
                <div v-if="categories.length > 2" class="group aspect-h-1 aspect-w-2 overflow-hidden rounded-lg sm:aspect-none sm:relative sm:h-full">
                    <img :src="'/storage/' + categories[2].image" :alt="categories[2].description" class="object-cover object-center group-hover:opacity-75 duration-300 ease-in-out group-hover:scale-110 sm:absolute sm:inset-0 sm:h-full sm:w-full" />
                    <div aria-hidden="true" class="bg-gradient-to-b from-transparent to-black opacity-50 sm:absolute sm:inset-0" />
                    <div class="flex items-end p-6 sm:absolute sm:inset-0">
                        <div>
                            <h3 class="font-semibold text-white">
