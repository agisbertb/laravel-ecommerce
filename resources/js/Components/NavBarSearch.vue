<template>
    <!-- Campo de búsqueda fijo que también forma parte del componente de búsqueda animado -->
    <div class="relative" @click="open = true">
        ...
        <input class="h-12 w-full border-0 bg-transparent pl-11 pr-4 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm" placeholder="Search..." :class="{ 'visible': !open, 'invisible': open }" />


    <TransitionRoot :show="open" as="template" @after-leave="open = false">
