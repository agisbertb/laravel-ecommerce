                            ...
                            <transition name="dropdown" enter-active-class="transition ease-out duration-200"
                                ...
                                <div v-show="showDropdown"
                                    ...
                                    <ul class="text-gray-700">
                                        ...
                                        <li>
                                            <button class="block px-4 py-2 hover:bg-gray-100 w-full text-left text-sm"
                                                @click="sortBy('stock_asc')">Stock: Low to High</button>
                                        </li>
                                        <li>
                                            <button class="block px-4 py-2 hover:bg-gray-100 w-full text-left text-sm"
                                                @click="sortBy('stock_desc')">Stock: High to Low</button>
                                        </li>
                                    </ul>
                                </div>
                            </transition>
                                    ...
                                    <thead class="bg-gray-100">
                                        <tr>
                                            <th scope="col"
                                                ...
                                                Image</th>
                                            <th scope="col"
                                                class="px-3 py-3.5 text-sm font-semibold text-center text-gray-900">Name
                                            </th>
                                            <th scope="col"
                                                class="px-3 py-3.5 text-sm font-semibold text-center text-gray-900">
                                                Description</th>
                                ...
                                <div class="flex items-center border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
                                    ...
                                    <div class="flex justify-end flex-grow">
                                        <nav class="inline-flex rounded-md shadow-sm" aria-label="Pagination">
                                            ...
                                            <template
                                                v-for="page in paginationRange(products.current_page, products.last_page)"
                                                :key="page">
                                                <a :href="`?page=${page}`" :class="{
                        'bg-blue-600 text-white border-blue-600': page === products.current_page,
                        'border-t border-b border-gray-300 text-gray-700 hover:bg-gray-50': page !== products.current_page,
                        'border-r': page !== products.last_page
