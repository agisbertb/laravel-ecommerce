<template>
    <AdminLayout title="Favorite Products">
                            ...
                            <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
                                <table class="min-w-full divide-y divide-gray-300">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="px-3 py-3.5 text-sm font-semibold text-center text-gray-900">Price</th>
                                        <th scope="col" class="px-3 py-3.5 text-sm font-semibold text-center text-gray-900">Stock</th>
                                    </tr>
                                    </thead>
...
const pages = [
    ...
    { name: 'Favorite', href: '/admin/products/favorite', current: true },
];
