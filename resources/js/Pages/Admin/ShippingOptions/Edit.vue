...
<template>
    <AdminLayout title="Update shippingOption">
            ...
            <nav class="flex" aria-label="Breadcrumb">
                <ol role="list" class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            <ChevronRightIcon class="h-5 w-5 flex-shrink-0 text-gray-400" aria-hidden="true" />
                            <Link href="/admin/shipping-options"
                                  class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Shipping Options</Link>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
                ...
                <div class="flex justify-center px-4 py-8">
                    <div class="w-full max-w-4xl mx-auto bg-white p-8">
                        <div class="mb-8">
                            ...
                            <p class="text-gray-600 text-sm text-center">Complete the form below to update a Shipping Option in
                                your store.</p>
                        </div>
                        <form @submit.prevent="update" class="space-y-6">
                            ...
                            <div>
                                <label for="name" class="block text-sm font-medium text-gray-700">Estimated delivery</label>
                                <input v-model="form.estimated_delivery" type="text" id="estimated_delivery" name="estimated_delivery"
                                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                       placeholder="24h">
                            </div>
